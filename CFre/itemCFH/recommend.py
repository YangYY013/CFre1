...
if __name__ == '__main__':
    ...
    W_dict = readWcn("D:/PycharmProjects/untitled2/itemCFH/W_0.txt")
    ...
    user_id =263
    user_dict = createUser_Dict(readUser_item("D:/PycharmProjects/untitled2/itemCFH/user_263_train.csv"))
    data = recommondation(user_id, user_dict, W, 50)  # 这里的80 是对item相似度求前80
    print data
